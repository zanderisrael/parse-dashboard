...
export default class PushFiltersIndexRow extends PushAudiencesBaseRow {
  constructor() {
    super();
    this.state = {
      loading: true,
...
PushFiltersIndexRow.propTypes = {
  ...
  filter: PropTypes.string.describe(
    'The filter data of the push audience option.'
  ),
